            ...
            .then(function (html) {
                ...
                if (schedule.length > 1) {
                    for (i = 0; i < schedule.length; i++) {
                        ...
                        var datetime = Date.parse(schedule[i][0].replace(", ", " " + Date().getFullYear() + " ") + schedule[i][1].replace(" ", " ") + " EDT")//this stupid 'no-break' space was messing up Date.parse and I was losing my mind
