            ...
            if(args[0].options[0].name == "par_times"){
                ...
                if(numb == null){ 
                    ...
                    //1. calculate avg speed given upgrades
                        ...
                        cooldistance =boost*Math.log(Math.abs(11*e19^(framerate*(100/heatrate))*heatrate+7500*e19^(framerate*(100/heatrate+100/coolrate))))/(Math.log(e19)*framerate)-boost*Math.log(Math.abs(11*e19^(framerate*(100/heatrate))*heatrate+7500*e19^(framerate*(100/heatrate))))/(ln(e19)*framerate)
