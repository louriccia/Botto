...
exports.about = {
    ...
    swinnings: {
        name: "Submissions and Winnings", emoji: "⏱️", desc: "When you've finished the challenge and you're happy with your time, you can click the submit button and a modal should pop up. Submit your time in the same format as it appears in the results screen and you may add a small note as well. Truguts are awarded depending on how fast your submitted time is compared to the given goal times and how your winnings are set up. In addition to the goal time winnings, bonuses are available for beating other players' best times, beating your own time, rating challenges, daily streaks, and completing non-standard or long challenges. You'll also earn a random item the first time you complete any given challenge configuration -- replays of a track/racer/condition combo you've already played don't drop items."
    },
    reroll: {
    ...
    bribes: {
        name: "Bribes", emoji: "💰", desc: "If you slip a few truguts under the table, Botto will let you change the track and/or racer of any active challenge once. Press 💰 Bribe, stage your changes with the dropdowns, then press **Bribe** to apply them all at once -- nothing is charged until you do. Bribes are useful for finding achievement-specific challenges, bounties, or beating the awful RNG. Submitting a bribe will reset the 15 minute timer on private challenges. Completing the **Arrow Dynamics** collection also unlocks condition bribes (no upgrades, mirror, backwards, skips, and lap count) at the track-bribe price per change."
    },
    hints: {
