...
exports.drop = async function ({ interaction, user_profile, user_profile_ref, args, db, database, member_id } = {}) {
    ...
    let p = manageTruguts({ user_profile, user_profile_ref, transaction: 'd', amount: DROP })
